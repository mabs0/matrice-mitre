...
parcours complet est joué — accueil, création d'un layer, les questionnaires du
catalogue, report des scores dans la matrice, méthodes de notation et
d'agrégation, contributions entre mitigations, filtre de plateforme, modale d'une
technique, aller-retour export/import (JSON clair, JSON chiffré, Excel, classeur
d'origine), ordre de parcours, atteignabilité du niveau 0, progression du
téléchargement, robustesse à un HTML en cache, retour à l'accueil et bascule de
thème.
